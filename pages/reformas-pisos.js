  ...
  return (
    <SCPisos>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Reformas de Pisos Integrales</h1>
        <p className="p-obra-nueva">Da una nueva vida a tu hogar</p>
      </div>
      ...
      <section className="section-obra-formulario">
        <div className="div-general-obra">
          <p className="p1-obra">
            ...
            piso, desde su diseño hasta su ejecución, dandole una nueva vida.
          ...
          <div className="div-general-cartas">
            <div className="div-primera-carta">
              ...
              <div className="div-primera-subcarta">
                ...
                <p className="p3-obra">
                  ¿Quieres reformar tu piso? Puedes contactar con nosotos por
