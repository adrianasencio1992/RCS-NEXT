...
import SCMaella from "./maella.styled";
import Link from "next/link";

export default function Maella() {
  return (
    <SCMaella>
      <Layout></Layout>
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Maella</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <span className="span"> ˃ </span>
          <Link href="/muebles-de-cocina/puertas/lacadas/maella">
            <a className="link2">Maella</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">MAELLA</h2>
          <hr className="hr-formulario"></hr>
        </section>

        <section className="section-datos">
          <div className="div-fotos">
            <img className="imagen-1" src="/lacadas/Maella.jpg"></img>
          </div>
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">Maella Tipo 2</td>
              </tr>
              <tr>
                <td>ACABADO</td>
