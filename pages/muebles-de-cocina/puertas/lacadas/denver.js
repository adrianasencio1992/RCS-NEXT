    ...
    <SCDenver>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <span className="span"> ˃ </span>
          <Link href="/muebles-de-cocina/puertas/lacadas/denver">
        ...
        <section className="section-fotos">
          ...
          <div className="div-fotos">
            <img className="imagen-1" src="/lacadas/denver.jpg"></img>
            <img className="imagen-2" src="/lacadas/denver-cocina.jpg"></img>
          </div>
        </section>
          ...
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">Gris Perla</td>
              </tr>
              <tr>
