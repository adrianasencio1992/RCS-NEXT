...
import SCOrleans from "./orleans.styled";
import Link from "next/link";

export default function Orleans() {
  return (
    <SCOrleans>
      <Layout></Layout>
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Orleans</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <span className="span"> ˃ </span>
          <Link href="/muebles-de-cocina/puertas/lacadas/orleans">
            <a className="link2">Orleans</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">ORLEANS</h2>
          <hr className="hr-formulario"></hr>
        </section>

        <section className="section-datos">
          <div className="div-fotos">
            <img className="imagen-1" src="/lacadas/Orleans.jpg"></img>
          </div>
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">Orleans</td>
              </tr>
              <tr>
                <td>ACABADO</td>
              ...
              <tr>
                ...
                <td className="derecha">Marfil</td>
              </tr>
              <tr>
