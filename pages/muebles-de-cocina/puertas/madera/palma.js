...
import SCPalma from "./palma.styled";
  ...
  return (
    <SCPalma>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Palma</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <span className="span"> ˃ </span>
          <Link href="/muebles-de-cocina/puertas/lacadas/palma">
            <a className="link2">Palma</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">PALMA</h2>
          <hr className="hr-formulario"></hr>
        </section>

        <section className="section-datos">
          <div className="div-fotos">
            <img className="imagen-1" src="/lacadas/Palma.jpg"></img>
          </div>
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">19mm | 22 mm</td>
              </tr>
              <tr>
                <td>TIRADOR</td>
