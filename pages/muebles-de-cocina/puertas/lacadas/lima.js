...
import SCLIMA from "./LIMA.styled";
  ...
  return (
    <SCLIMA>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">LIMA</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <span className="span"> ˃ </span>
          <Link href="/muebles-de-cocina/puertas/lacadas/lima">
            <a className="link2">Lima</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">LIMA</h2>
          <hr className="hr-formulario"></hr>
        </section>

        <section className="section-datos">
          <div className="div-fotos">
            <img className="imagen-1" src="/lacadas/LIMA.jpg"></img>
          </div>
