...
const SCSliderAluminio = styled.section`
...
.checkbox:not(:checked) + label{
  ...
  background-image: url('/aluminio1.jpg');
...
.checkbox.scnd + label{
  background-image: url('/aluminio2.jpg');
}
.checkbox.thrd + label{
  background-image: url('/aluminio3.jpg');
}
.checkbox.foth + label{
  background-image: url('/aluminio4.jpg');
}
.checkbox.cinc + label{
  background-image: url('/aluminio5.jpg');
}
.checkbox.sis + label{
  background-image: url('/aluminio6.jpg');
}
.checkbox.set + label{
  background-image: url('/aluminio7.jpg');
}
.checkbox.vuit + label{
  background-image: url('/aluminio8.jpg');
}
.checkbox.nou + label{
  background-image: url('/aluminio9.jpg');
}
...
export default SCSliderAluminio;
