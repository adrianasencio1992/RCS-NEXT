...
import SCXativa from "./xativa.styled";
import Link from "next/link";

export default function Xativa() {
  return (
    <SCXativa>
      <Layout></Layout>
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Xátiva</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <span className="span"> ˃ </span>
          <Link href="/muebles-de-cocina/puertas/lacadas/xativa">
            <a className="link2">Xátiva</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">XÁTIVA</h2>
          <hr className="hr-formulario"></hr>
        </section>

        <section className="section-datos">
          <div className="div-fotos">
            <img className="imagen-1" src="/lacadas/Xátiva.jpg"></img>
          </div>
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">Xativa</td>
              </tr>
              <tr>
                <td>ACABADO</td>
