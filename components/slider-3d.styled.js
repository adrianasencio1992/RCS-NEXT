...
const SCSlider3d = styled.section`
...
.checkbox.scnd + label{
  background-image: url('/3d-1.jpg');
}
.checkbox.thrd + label{
  background-image: url('/3d-2.jpg');
}
.checkbox.foth + label{
  background-image: url('/3d-3.jpg');
}
.checkbox.cinc + label{
  background-image: url('/3d-4.jpg');
}
.checkbox.sis + label{
  background-image: url('/3d-5.jpg');
}
.checkbox.set + label{
  background-image: url('/3d-6.jpg');
}
.checkbox.vuit + label{
  background-image: url('/3d-7.jpg');
}
.checkbox.nou + label{
  background-image: url('/3d-8.jpg');
}
