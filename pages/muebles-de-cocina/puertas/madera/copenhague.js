...
import SCCopenhague from "./copenhague.styled";
import Link from "next/link";

export default function Copenhague() {
  if (typeof $ !== "undefined") {
  }
  return (
    <SCCopenhague>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Copenhague</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <Link href="/muebles-de-cocina/puertas/madera/copenhague">
            <a className="link2">Copenhague</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">Copenhague</h2>
          <hr className="hr-formulario"></hr>
        </section>

        <section className="section-datos">
          <div className="div-fotos">
            <img className="imagen-1" src="/madera/Conpenhage.jpg"></img>
          </div>
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">Copenhague</td>
              </tr>
              <tr>
                <td>MADERA</td>
