...
import SCOrlando from "./orlando.styled";
  ...
  return (
    <SCOrlando>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Orlando</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <Link href="/muebles-de-cocina/puertas/madera/orlando">
            <a className="link2">Orlando</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">Orlando</h2>
          <hr className="hr-formulario"></hr>
        </section>

        <section className="section-datos">
          <div className="div-fotos">
            <img className="imagen-1" src="/madera/Orlando.jpg"></img>
            <img className="imagen-2" src="/madera/Orlando-cocina.jpg"></img>
          </div>
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">Orlando</td>
              </tr>
              <tr>
                <td>MADERA</td>
