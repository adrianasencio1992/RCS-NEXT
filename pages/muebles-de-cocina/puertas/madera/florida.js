...
import SCFlorida from "./florida.styled";
  ...
  return (
    <SCFlorida>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Florida</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <Link href="/muebles-de-cocina/puertas/madera/florida">
            <a className="link2">Florida</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">Florida</h2>
          <hr className="hr-formulario"></hr>
        </section>

        <section className="section-datos">
          <div className="div-fotos">
            <img className="imagen-1" src="/madera/Florida.jpg"></img>
            <img className="imagen-2" src="/madera/Florida-cocina.jpg"></img>
          </div>
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">Florida</td>
              </tr>
              <tr>
                <td>MADERA</td>
