...
const SCSliderCocinas = styled.section`
...
.checkbox.scnd + label{
  background-image: url('/cocina2.jpg');
}
.checkbox.thrd + label{
  background-image: url('/cocina33.jpg');
}
.checkbox.foth + label{
...
.checkbox.sis + label{
  background-image: url('/cocina6.jpg');
}
.checkbox.set + label{
  background-image: url('/cocina7.jpg');
}
.checkbox.vuit + label{
  background-image: url('/cocina8.jpg');
}
.checkbox.nou + label{
  background-image: url('/cocina9.jpg');
}
...
export default SCSliderCocinas;
