...
const SCSliderFontaneria = styled.section`
...
.checkbox:not(:checked) + label{
  ...
  background-image: url('/fontaneria1.jpg');
...
.checkbox.scnd + label{
  background-image: url('/fontaneria2.jpg');
}
.checkbox.thrd + label{
  background-image: url('/fontaneria3.jpg');
}
.checkbox.foth + label{
  background-image: url('/fontaneria4.jpg');
}
.checkbox.cinc + label{
  background-image: url('/fontaneria5.jpg');
}
.checkbox.sis + label{
  background-image: url('/fontaneria6.jpg');
}
.checkbox.set + label{
  background-image: url('/fontaneria7.jpg');
}
.checkbox.vuit + label{
  background-image: url('/fontaneria8.jpg');
}
.checkbox.nou + label{
  background-image: url('/fontaneria9.jpg');
}
...
export default SCSliderFontaneria;
