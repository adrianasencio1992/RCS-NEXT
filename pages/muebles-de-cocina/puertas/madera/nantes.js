...
import SCNantes from "./nantes.styled";
  ...
  return (
    <SCNantes>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Nantes</h1>
      ...
      <section className="section">
        ...
        <section className="section-fotos">
          <h2 className="h2-formulario">Nantes</h2>
          <hr className="hr-formulario"></hr>
        </section>

        <section className="section-datos">
          <div className="div-fotos">
            <img className="imagen-1" src="/madera/Nantes.jpg"></img>
          </div>
