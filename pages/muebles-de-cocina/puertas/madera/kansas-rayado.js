...
import SCKansasRayado from "./kansas-rayado.styled";
import Link from "next/link";

export default function KansasRayado() {
  if (typeof $ !== "undefined") {
  }
  return (
    <SCKansasRayado>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Kansas Plafón Rayado</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <Link href="/muebles-de-cocina/puertas/madera/kansas-rayado">
            <a className="link2">Kansas P. Rayado</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">Kansas Plafón Rayado</h2>
          <hr className="hr-formulario"></hr>
        </section>

        <section className="section-datos">
          <div className="div-fotos">
            <img className="imagen-1" src="/madera/Kansas-rayado.jpg"></img>
          </div>
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">Kansas Plafón Rayado</td>
              </tr>
              <tr>
                <td>MADERA</td>
              ...
              <tr>
                ...
                <td className="derecha">Fresno | Roble </td>
              </tr>
              <tr>
                <td>GROSOR</td>
