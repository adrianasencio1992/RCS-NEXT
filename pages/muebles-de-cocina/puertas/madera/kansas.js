...
import SCKansas from "./kansas.styled";
  ...
  return (
    <SCKansas>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Kansas</h1>
          ...
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">KANSAS PLAFÓN LISO</td>
              </tr>
              <tr>
                <td>MADERA</td>
