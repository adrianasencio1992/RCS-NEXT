  ...
  <SCObraNueva>
    ...
    <section className="section-obra-formulario">
      <div className="div-general-obra">
        <p className="p1-obra">
          Nuestro equipo de profesionales se encargará de la construccion de su
        ...
        <div className="div-general-cartas">
          <div className="div-primera-carta">
            ...
            <div className="div-primera-subcarta">
              ...
              <p className="p3-obra">
                ¿Quieres construir tu nuevo hogar? Puedes contactar con nosotos
                por teléfono, via mail, pagina web, redes sociales o en nuesta
          ...
          <div className="div-primera-carta">
            ...
            <div className="div-primera-subcarta">
              ...
              <p className="p3-obra">
                ...
                nuevo proyecto. Este diseño no tendrá ningun coste añadido.
              </p>
            </div>
          </div>
        </div>
