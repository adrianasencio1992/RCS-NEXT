...
const SCSliderParquet = styled.section`
...
.checkbox.scnd + label{
  background-image: url('/parquet2.jpg');
}
.checkbox.thrd + label{
  background-image: url('/parquet3.jpg');
}
.checkbox.foth + label{
  background-image: url('/parquet4.jpg');
}
.checkbox.cinc + label{
  background-image: url('/parquet5.jpg');
}
.checkbox.sis + label{
  background-image: url('/parquet6.jpg');
}
.checkbox.set + label{
  background-image: url('/parquet7.jpg');
}
.checkbox.vuit + label{
  background-image: url('/parquet8.jpg');
}
.checkbox.nou + label{
  background-image: url('/parquet9.jpg');
}
...
export default SCSliderParquet;
