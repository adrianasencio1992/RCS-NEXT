  ...
  return (
    <SCReformasCasas>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Reformas de Casas</h1>
      ...
      <section className="section-obra-formulario">
        <div className="div-general-obra">
          <p className="p1-obra">
            ...
            hogar, desde su diseño hasta su ejecución, dándole una nueva vida.
          ...
          <div className="div-general-cartas">
            <div className="div-primera-carta">
              ...
              <div className="div-primera-subcarta">
                ...
                <p className="p3-obra">
                  ¿Quieres reformar tu casa? Puedes contactar con nosotros por
