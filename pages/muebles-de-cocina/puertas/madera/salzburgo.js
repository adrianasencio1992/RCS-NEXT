...
import SCSalzburgo from "./salzburgo.styled";
import Link from "next/link";

export default function Salzburgo() {
  if (typeof $ !== "undefined") {
  }
  return (
    <SCSalzburgo>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Salzburgo</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <Link href="/muebles-de-cocina/puertas/madera/salzburgo">
            <a className="link2">Salzburgo</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">Salzburgo</h2>
          <hr className="hr-formulario"></hr>
        </section>

        <section className="section-datos">
          <div className="div-fotos">
            <img className="imagen-1" src="/madera/Salzburgo.jpg"></img>
          </div>
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">Salzburgo</td>
              </tr>
              <tr>
                <td>MADERA</td>
