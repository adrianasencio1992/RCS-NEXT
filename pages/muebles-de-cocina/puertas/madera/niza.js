...
import SCNiza from "./niza.styled";
  ...
  return (
    <SCNiza>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Niza</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <Link href="/muebles-de-cocina/puertas/madera/niza">
            <a className="link2">Niza</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">Niza</h2>
          <hr className="hr-formulario"></hr>
        </section>

        <section className="section-datos">
          <div className="div-fotos">
            <img className="imagen-1" src="/madera/Niza.jpg"></img>
            <img className="imagen-2" src="/madera/Niza-cocina.jpg"></img>
          </div>
