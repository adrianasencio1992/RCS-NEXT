...
import SCOlimpia from "./olimpia.styled";
import Link from "next/link";

export default function Olimpia() {
  return (
    <SCOlimpia>
      <Layout></Layout>
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Olimpia</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <span className="span"> ˃ </span>
          <Link href="/muebles-de-cocina/puertas/lacadas/olimpia">
            <a className="link2">Olimpia</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">OLIMPIA</h2>
          <hr className="hr-formulario"></hr>
          <div className="div-fotos">
            <img className="imagen-1" src="/lacadas/Olimpia.jpg"></img>
            <img className="imagen-2" src="/lacadas/Olimpia-cocina.jpg"></img>
          </div>
        </section>
          ...
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">Olimpia</td>
              </tr>
              <tr>
                <td>ACABADO</td>
