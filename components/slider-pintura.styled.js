...
const SCSliderPintura = styled.section`
...
.checkbox:not(:checked) + label{
  ...
  background-image: url('/pintura1.jpg');
...
.checkbox.scnd + label{
  background-image: url('/pintura2.jpg');
}
.checkbox.thrd + label{
  background-image: url('/pintura3.jpg');
}
.checkbox.foth + label{
  background-image: url('/pintura4.jpg');
}
.checkbox.cinc + label{
  background-image: url('/pintura5.jpg');
}
.checkbox.sis + label{
  background-image: url('/pintura6.jpg');
}
.checkbox.set + label{
  background-image: url('/pintura7.jpg');
}
.checkbox.vuit + label{
  background-image: url('/pintura8.jpg');
}
.checkbox.nou + label{
  background-image: url('/pintura9.jpg');
}
...
export default SCSliderPintura;
