  ...
  return (
    <SCCocinas>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Reforma tu Cocina</h1>
        <p className="p-obra-nueva">¡Estrena fogones!</p>
      </div>
      ...
      <section className="section-obra-formulario">
        <div className="div-general-obra">
          <p className="p1-obra">
            ...
            cocina, desde su diseño hasta su ejecución, dándole una nueva vida.
          ...
          <div className="div-general-cartas">
            <div className="div-primera-carta">
              ...
              <div className="div-primera-subcarta">
                ...
                <p className="p3-obra">
                  ¿Quieres reformar tu cocina? Puedes contactar con nosotros por
            ...
            <div className="div-primera-carta2">
              <div className="div-primera-subcarta2">
                ...
                <p className="p3-obra2">
                  ...
                  necesidades, pudiendo elegir todos los elementos de tu cocina.
            ...
            <div className="div-primera-carta">
              ...
              <div className="div-primera-subcarta">
                ...
                <p className="p3-obra">
                  Una vez elijas todos los elementos de tu cocina, elaboraremos
