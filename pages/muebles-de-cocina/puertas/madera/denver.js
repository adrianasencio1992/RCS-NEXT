...
import SCDenver from "./denver.styled";
  ...
  return (
    <SCDenver>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Denver</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <Link href="/muebles-de-cocina/puertas/madera/denver">
            <a className="link2">Denver</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">Denver</h2>
          <hr className="hr-formulario"></hr>
        </section>

        <section className="section-datos">
          <div className="div-fotos">
            <img className="imagen-1" src="/madera/Denver.jpg"></img>
            <img className="imagen-2" src="/madera/Denver-cocina.jpg"></img>
          </div>
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">Denver</td>
              </tr>
              <tr>
                <td>MADERA</td>
