...
.checkbox:not(:checked) + label{
  ...
  background-image: url('/obranueva1.jpg');
...
.checkbox.scnd + label{
  background-image: url('/obranueva2.jpg');
}
.checkbox.thrd + label{
  background-image: url('/obranueva3.jpg');
}
.checkbox.foth + label{
  background-image: url('/obranueva4.jpg');
}
.checkbox.cinc + label{
  background-image: url('/obranueva5.jpg');
}
.checkbox.sis + label{
  background-image: url('/obranueva6.jpg');
}
.checkbox.set + label{
  background-image: url('/obranueva7.jpg');
}
.checkbox.vuit + label{
  background-image: url('/obranueva8.jpg');
}
.checkbox.nou + label{
