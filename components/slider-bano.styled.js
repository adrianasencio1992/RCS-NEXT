...
const SCSliderBano = styled.section`
...
.checkbox:not(:checked) + label{
  ...
  background-image: url('/bano1.jpg');
...
.checkbox.scnd + label{
  background-image: url('/bano2.jpg');
}
.checkbox.thrd + label{
  background-image: url('/bano3.jpg');
}
.checkbox.foth + label{
  background-image: url('/bano4.jpg');
}
.checkbox.cinc + label{
  background-image: url('/bano5.jpg');
}
.checkbox.sis + label{
  background-image: url('/bano6.jpg');
}
.checkbox.set + label{
  background-image: url('/bano7.jpg');
}
.checkbox.vuit + label{
  background-image: url('/bano8.jpg');
}
.checkbox.nou + label{
  background-image: url('/bano9.jpg');
}
