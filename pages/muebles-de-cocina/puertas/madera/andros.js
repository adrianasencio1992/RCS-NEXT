...
import SCAndros from "./andros.styled";
  ...
  return (
    <SCAndros>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Andros</h1>
          ...
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">Andros</td>
              </tr>
              <tr>
                <td>MADERA</td>
