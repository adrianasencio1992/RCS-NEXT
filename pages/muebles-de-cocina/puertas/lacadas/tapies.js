...
import SCTapies from "./tapies.styled";
import Link from "next/link";

export default function Tapies() {
  return (
    <SCTapies>
      <Layout></Layout>
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Tapies</h1>
      ...
      <section className="section">
        ...
        <section className="section-fotos">
          <h2 className="h2-formulario">TAPIES</h2>
          ...
          <div className="div-tabla">
            ...
            <table className="tabla">
              <tr>
                ...
                <td className="derecha">Tapies</td>
              </tr>
              <tr>
                <td>ACABADO</td>
              ...
              <tr>
                ...
                <td className="derecha">Pergamon</td>
              </tr>
              <tr>
