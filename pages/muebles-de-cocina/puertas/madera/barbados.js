...
import SCBarbados from "./barbados.styled";
  ...
  return (
    <SCBarbados>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Barbados</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <Link href="/muebles-de-cocina/puertas/madera/barbados">
            <a className="link2">Barbados</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">Barbados</h2>
          <hr className="hr-formulario"></hr>
        </section>

        <section className="section-datos">
          <div className="div-fotos">
            <img className="imagen-1" src="/madera/Barbados.jpg"></img>
          </div>
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">Barbados</td>
              </tr>
              <tr>
                <td>MADERA</td>

                <td className="derecha">Roble</td>
              </tr>
              <tr>
                <td>COLOR</td>

                <td className="derecha">t04</td>
              </tr>
              <tr>
                <td>ACABADO</td>
              ...
              <tr>
                ...
                <td className="derecha">Fresno | Roble | Roble Nudos</td>
              </tr>
              <tr>
                <td>GROSOR</td>
