...
const SCSliderPisos = styled.section`
...
.checkbox:not(:checked) + label{
  ...
  background-image: url('/piso1.jpg');
...
.checkbox.scnd + label{
  background-image: url('/piso2.jpg');
}
.checkbox.thrd + label{
  background-image: url('/piso3.jpg');
}
.checkbox.foth + label{
  background-image: url('/piso4.jpg');
}
.checkbox.cinc + label{
  background-image: url('/piso5.jpg');
}
.checkbox.sis + label{
  background-image: url('/piso6.jpg');
}
.checkbox.set + label{
  background-image: url('/piso7.jpg');
}
.checkbox.vuit + label{
  background-image: url('/piso8.jpg');
}
.checkbox.nou + label{
  background-image: url('/piso9.jpg');
}
