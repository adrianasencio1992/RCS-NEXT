...
import SCMarina from "./Marina.styled";
  ...
  return (
    <SCMarina>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Marina</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <span className="span"> ˃ </span>
          <Link href="/muebles-de-cocina/puertas/lacadas/marina">
            <a className="link2">Marina</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">MARINA</h2>
          ...
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">Marina</td>
              </tr>
              <tr>
                <td>ACABADO</td>
