...
import SCArles from "./arles.styled";
  ...
  return (
    <SCArles>
      ...
      <div className="div-obra-nueva">
        <h1 className="h1-obra-nueva">Arlés</h1>
      ...
      <section className="section">
        <div className="div-links">
          ...
          <span className="span"> ˃ </span>
          <Link href="/muebles-de-cocina/puertas/lacadas/arles">
            <a className="link2">Arlés</a>
          </Link>
        </div>

        <section className="section-fotos">
          <h2 className="h2-formulario">ARLÉS</h2>
          <hr className="hr-formulario"></hr>
        </section>

        <section className="section-datos">
          <div className="div-fotos">
            <img className="imagen-1" src="/lacadas/Arlés.jpg"></img>
          </div>
          <div className="div-tabla">
            ...
            <table className="tabla">
              ...
              <tr>
                ...
                <td className="derecha">Lándalo</td>
              </tr>
              <tr>
